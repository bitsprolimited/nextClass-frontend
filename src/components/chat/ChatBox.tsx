...
export default function ChatBox() {
  return (
    <div className="flex flex-col h-full bg-white rounded-tr-xl rounded-br-xl overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 bg-[#031d95] text-white">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <h4 className="font-semibold text-lg leading-snug">King James</h4>
      ...
      <div className="h-[14px] bg-[#fbbd35]" />
        ...
        <div className="flex flex-col space-y-6">
          {messages.map((msg) => (
            <div
              key={msg.id}
              className={
                `max-w-[75%] px-4 py-2 rounded-xl relative text-sm leading-relaxed ` +
                (msg.sender === "me"
            ...
            >
              ...
              <span className="absolute right-3 bottom-[-1.2rem] text-[10px] text-gray-400">
                {msg.timestamp}
              </span>
            </div>
          ))}
      ...
      <form className="flex items-center gap-2 px-4 py-3 border-t bg-white">
        <div className="relative flex-1">
          <Input
            ...
            className="w-full bg-gray-100 rounded-full pr-20"
          />
