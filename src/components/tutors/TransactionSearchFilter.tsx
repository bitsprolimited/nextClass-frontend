...
export default function SearchAndFilter({
  ...
  return (
    <div className="flex flex-col items-start p-5 gap-2 bg-[#f5f4f8] w-full mt-5">
      <div className="flex w-full justify-between items-center py-3 pr-6 shadow-[0px_4px_4px_#031d9540] focus-within:ring-1 focus-within:ring-primary rounded-sm">
        <Input
          ...
          placeholder="Search by Transaction ID, Name, subject etc"
        />
        <Button
          className="px-[50px] py-4 rounded-full h-auto font-medium text-lg hover:bg-primary bg-secondary"
