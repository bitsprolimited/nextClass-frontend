...
export default function Testimonial() {
  return (
    <>
      <section className="relative w-full bg-[#0027A5] text-white py-20 px-6 md:px-20 overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto p-6 text-center bg-transparent">
          ...
          <p className="text-lg leading-relaxed text-white/90 mb-6">
            ...
            the 1500s when unknown printer took a galley of type and scrambled
            it to.”
          </p>
      ...
      <section className="flex flex-col items-start w-full pt-[140px] pb-0 px-6 lg:px-12 relative">
        <div className="w-full bg-background3 max-w-7xl mx-auto">
          <div className="text-center flex flex-col items-center gap-5 py-36 px-4 md:px-8 lg:px-12 relative">
            <Image
              src="/images/switch-shape.png"
              alt="Switch shape"
              width={200}
              height={300}
              className="absolute top-[50px] -right-[100px] z-0"
            />
            <p className="text-sm uppercase tracking-widest text-[#031d95] whitespace-nowrap font-semibold">
              Work with trusted tutors
            </p>
            <h2 className="text-zeus text-[57px]/[62px]">
              We Have 800+ Trusted Tutors and Instructors
            </h2>

            <p className="font-medium text-[#555060]">
              Meet professionally verified and certified tutors from all over
              the world
            </p>
          </div>
        </div>
