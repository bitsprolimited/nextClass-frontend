      ...
      <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex gap-4 items-start mb-4">
            ...
            <div className="flex-1 w-full">
              ...
              <p className="text-sm text-gray-500">
                4.8/5 <span className="text-yellow-500">★★★★★</span> 200 Reviews
              </p>
        ...
        <div className="bg-[#FFF5E9] rounded-xl shadow-md p-6 w-full lg:max-w-sm">
          <h3 className="text-xl font-semibold text-[#FFA300] mb-2">
            Welcome, <p className=" text-[#031D95] font-bold">Ryan Patterson</p>
          </h3>
          ...
          <blockquote className="italic text-sm text-gray-600 mb-6">
            “Let’s focus on what we can do today, so that tomorrow, we will reap
