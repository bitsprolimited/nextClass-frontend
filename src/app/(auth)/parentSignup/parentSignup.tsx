          ...
          <form className="mt-8 space-y-5">
            <div className="w-[70%] mx-auto space-y-5">
              <h2 className=" text-2xl font-semibold">
                Parents’ <span className="text-[#FFA300]">Registration</span>
              </h2>
            ...
            <div className="flex gap-4 justify-center mt-4">
              <Button className="bg-blue-900 text-white rounded-full px-6 py-4 flex items-center gap-2 shadow border">
